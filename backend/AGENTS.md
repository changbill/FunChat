...
| `docs/architecture.md` | 전체 설계와 모듈 관계(데이터 흐름 포함)                                                    |
| `docs/conventions.md`  | 코드 스타일/네이밍/계층 규칙                                                               |
| `docs/api-patterns.md` | 컨트롤러/DTO/응답 형식, 페이징/커서 패턴                                                   |
| `docs/db.md`           | JPA/MySQL, Mongo, Redis 사용 규칙 및 로컬 실행 힌트                                        |
| `docs/testing.md`      | 테스트 전략, Testcontainers, 실행 방법                                                     |
| `docs/security.md`     | 보안 전략                                                                                  |
...
- **테스트 작성**: 기능 구현 시 반드시 테스트를 작성하고 통과시킨 후 완료로 간주한다.
...
- 기능 명세 변경 시 `docs/SPEC.md`를, 진행 상황 변경 시 `docs/PLAN.md`를 갱신한다.
