...
## Phase 3 — 일반·영상 채팅방 구분

- [x] Room 유형 저장, 생성/응답 및 목록 필터 추가. 기존 요청/행은 TEXT.
- [x] 일반방 영상 API 거부 및 방 삭제 시 영상 세션 정리.

검증:
- [x] 유형 필터/저장, 영상 권한, API 호환 및 영상방 퇴장 회귀 테스트.
- [x] Gradle test/build (105 tests, 실패/스킵 0).
